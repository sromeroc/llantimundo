...
export default class Auth extends PageManager {
    ...
    registerPasswordlessLoginValidation($passwordlessLoginForm) {
        const loginModel = forms;
        ...
        $passwordlessLoginForm.on('submit', event => {
            this.loginValidator.performCheck();
    ...
    onReady() {
        ...
        const $loginForm = classifyForm('.login-form-standard');
        const $passwordlessLoginForm = classifyForm('.login-form-passwordless');
